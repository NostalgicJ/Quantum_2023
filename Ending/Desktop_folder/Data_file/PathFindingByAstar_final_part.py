...
phi_list = [[0.1, 0.6], [0.7, 1.4], [1.6, 2.2], [2.5, 2.9], [3.1, 3.8], [4.0, 4.6], [4.7, 4.6], [4.8, 5.3], [5.7, 6.3]]

rand_list = [0, 1, 2, 3, 4, 5, 6, 7]

while True : 

    my_rand = random.choice(rand_list)

    case += 1
    theta, phi = (pi/180)*random.uniform(90, 120), random.uniform(phi_list[my_rand][0], phi_list[my_rand][1])
