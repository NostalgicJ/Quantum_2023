...
# 결측 구간이 d0에 따라 달라지는지 확인
# 데이터를 보면 알겠지만 거의 안 나오던 구간에서 완화되어 좀 나오는 편
d0 = 0.20           # Arbitrary settings, Actual speed : 0.30rad/μs
dt = 2.6 
...
filename = "/ByAstar_Rho_version_H3_Omega_d0-test_" + printdate + '.csv'
